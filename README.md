...
| server_public_ipv4_id                 | `string`       | `null`          | <b>No</b>         | Assign IPv4 address generated outside of this module instead of creating one with this module |
| server_enable_public_ipv6             | `bool`         | `false`         | <b>No</b>         | Enable or disable Public IPv6 address |
| server_public_ipv4_id                 | `string`       | `null`          | <b>No</b>         | Assign IPv6 address generated outside of this module instead of creating one with this module |
